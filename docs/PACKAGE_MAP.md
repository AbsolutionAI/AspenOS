...
**Status:** COMPLETE for v1 public mesh — 2026-08-06 · **reviewed 2026-08-22** (ASP-46 / BEL-164)  
...
**Last review:** `docs/ops/PACKAGE_MESH_REVIEW_2026-08-22.md`  
...
| Repo | License | Notes |
|------|---------|-------|
| [aspen-dev](https://github.com/AbsolutionAI/aspen-dev) | Apache-2.0 | Master Spec organ: Paperclip/Hermes/CE SoR (redacted) |
...
| [aspen-matrix-ops](https://github.com/AbsolutionAI/aspen-matrix-ops) | Apache-2.0 | docs-only Matrix homeserver |
...
## Hermes skills
- `aspen-package-mesh` — packaging order, map/ADR, publish recipe  
- `repo-documentation-standard` — third-party doc checklist
...
- Private org migration for Leonardo/Family/abs-wm-mcp — **BEL-177 deferred**; residual `docs/ops/PRIVATE_LANE_BEL177.md` · public index [aspen-private-lane](https://github.com/AbsolutionAI/aspen-private-lane)
