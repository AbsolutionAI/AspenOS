# Nightly Packaging & Deployment Check — 2026-09-13 08:02 UTC

**Run:** [ASP-591](/ASP/issues/ASP-591) routine execution
**Agent:** Opencode (Aspen Implementation Engineer)
**Workspace:** `/home/tech/projects/aspen-dev/repos/aspen-os`
**Branch:** `master` (HEAD `21af3e1`)
...
the single failure is the known hardware-dependent C11 p50 benchmark (3.423ms measured,
ADR 0001 requires < 2ms). Total runtime 13.6s (incremental build cache).
...
| Debian package | PASS | `dist/starship-os_2.2.0_amd64.deb`, 6.7MB, 111 entries (65 under opt/starship) |
...
| shell syntax | 36 | 36 | — |
| deb package | 6.7MB / 111 files | 6.7MB / 111 files | — |
