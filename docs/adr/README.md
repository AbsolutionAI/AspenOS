...
| [ADR-0007](./ADR-0007-nats-subject-contracts-sentinel-c2.md) | NATS subject contracts for Sentinel + C2 | **Accepted** | BEL-196 — ASP-530/563; ASP-627: contracts mirror + overview producer closed |
