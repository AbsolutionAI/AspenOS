...
# H-017: ship placeholder-only legacy conf under .deprecated
cp "$REPO_DIR/nats/server.conf" "$INSTALLED/etc/agnetic/nats/server.conf.deprecated" 2>/dev/null || true
